module.exports = {
    name: "Purpose of Test Automation",
    keyPoints: [
        {
            name: "Test automation is used for:",
            pointSummary: [
        ...
        {
            name: "Interaction with a SUT via:",
            pointSummary: [
                "API (low-level)",
                "GUI (high-level)",
                "Service or protocol"
        ...
        {
            name:"Test automation objectives:",
            pointSummary: [
                "Improving test efficiency",
                "Providing wider function coverage",
                "Reducing total test cost",
        ...
        {
            name:"Advantages of test automation:",
            pointSummary:[
                "More tests can be run per build",
                `The possibility to create tests 
                    that cannot be done manually (real-time, remote, parallel tests)`,
        ...
        {
            name:"Disadvantages of test automation:",
            pointSummary: [
